...
DBpanelParser::DBpanelParser( wxWindow* parent )
:
DBpanel( parent )
{
...
void DBpanelParser::OnStatusTypeChange( wxCommandEvent& event )
{
...
void DBpanelParser::OnCopy( wxCommandEvent& event )
{
// TODO: Implement OnCopy
}

void DBpanelParser::OnPaste( wxCommandEvent& event )
{
// TODO: Implement OnPaste
}

void DBpanelParser::OnSave( wxCommandEvent& event )
{
	SaveData();
...
void	DBpanelParser::PopulateData() {
    ...
    MH4U::Save::FillDBpanel(
        m_choiceBonus,
        m_choiceAtkLvl);
}

void	DBpanelParser::ParseData() {
