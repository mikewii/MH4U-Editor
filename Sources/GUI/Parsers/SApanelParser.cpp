...
SApanelParser::SApanelParser( wxWindow* parent )
:
SApanel( parent )
{
...
void SApanelParser::OnStatusTypeChange( wxCommandEvent& event )
{
...
void SApanelParser::OnCopy( wxCommandEvent& event )
{
// TODO: Implement OnCopy
}

void SApanelParser::OnPaste( wxCommandEvent& event )
{
// TODO: Implement OnPaste
}

void SApanelParser::OnSave( wxCommandEvent& event )
{
	SaveData();
...
void	SApanelParser::PopulateData() {
    ...
    MH4U::Save::FillSApanel(
        m_choiceBonus,
        m_choiceAtkLvl);
}

void	SApanelParser::ParseData() {
