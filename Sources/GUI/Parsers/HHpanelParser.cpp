...
HHpanelParser::HHpanelParser( wxWindow* parent )
:
HHpanel( parent )
{
...
void HHpanelParser::OnStatusTypeChange( wxCommandEvent& event )
{
...
void HHpanelParser::OnCopy( wxCommandEvent& event )
{
// TODO: Implement OnCopy
}

void HHpanelParser::OnPaste( wxCommandEvent& event )
{
// TODO: Implement OnPaste
}

void HHpanelParser::OnSave( wxCommandEvent& event )
{
	SaveData();
...
void	HHpanelParser::PopulateData() {
    ...
    MH4U::Save::FillHHpanel(
        m_bcomboBoxSongs,
        m_choiceAtkLvl);
}

void	HHpanelParser::ParseData() {
