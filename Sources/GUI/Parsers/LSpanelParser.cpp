...
LSpanelParser::LSpanelParser( wxWindow* parent )
:
LSpanel( parent )
{
...
void LSpanelParser::OnStatusTypeChange( wxCommandEvent& event )
{
...
void LSpanelParser::OnCopy( wxCommandEvent& event )
{
// TODO: Implement OnCopy
}

void LSpanelParser::OnPaste( wxCommandEvent& event )
{
// TODO: Implement OnPaste
}

void LSpanelParser::OnSave( wxCommandEvent& event )
{
	SaveData();
...
void	LSpanelParser::PopulateData() {
    ...
    MH4U::Save::FillLSpanel(
        m_choiceBonus,
        m_choiceAtkLvl);
}

void	LSpanelParser::ParseData() {
