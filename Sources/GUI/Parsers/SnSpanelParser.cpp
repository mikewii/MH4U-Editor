...
SnSpanelParser::SnSpanelParser( wxWindow* parent )
:
SnSpanel( parent )
{
...
void SnSpanelParser::OnStatusTypeChange( wxCommandEvent& event )
{
...
void SnSpanelParser::OnCopy( wxCommandEvent& event )
{
// TODO: Implement OnCopy
}

void SnSpanelParser::OnPaste( wxCommandEvent& event )
{
// TODO: Implement OnPaste
}

void SnSpanelParser::OnSave( wxCommandEvent& event )
{
	SaveData();
...
void	SnSpanelParser::PopulateData() {
    ...
    MH4U::Save::FillSnSpanel(
        m_choiceBonus,
        m_choiceAtkLvl);
}

void	SnSpanelParser::ParseData() {
