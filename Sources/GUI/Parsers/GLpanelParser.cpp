...
GLpanelParser::GLpanelParser( wxWindow* parent )
:
GLpanel( parent )
{
...
void GLpanelParser::OnStatusTypeChange( wxCommandEvent& event )
{
...
void GLpanelParser::OnCopy( wxCommandEvent& event )
{
// TODO: Implement OnCopy
}

void GLpanelParser::OnPaste( wxCommandEvent& event )
{
// TODO: Implement OnPaste
}

void GLpanelParser::OnSave( wxCommandEvent& event )
{
	SaveData();
...
void	GLpanelParser::PopulateData() {
    ...
    MH4U::Save::FillGLpanel(
        m_choiceBonus,
        m_choiceAtkLvl);
}

void	GLpanelParser::ParseData() {
