...
HammerPanelParser::HammerPanelParser( wxWindow* parent )
:
HammerPanel( parent )
{
...
void HammerPanelParser::OnStatusTypeChange( wxCommandEvent& event )
{
...
void HammerPanelParser::OnCopy( wxCommandEvent& event )
{
// TODO: Implement OnCopy
}

void HammerPanelParser::OnPaste( wxCommandEvent& event )
{
// TODO: Implement OnPaste
}

void HammerPanelParser::OnSave( wxCommandEvent& event )
{
    SaveData();
...
void	HammerPanelParser::PopulateData() {
    ...
    MH4U::Save::FillHammerPanel(
        m_choiceBonus,
        m_choiceAtkLvl);
}

void	HammerPanelParser::ParseData() {
...
void HammerPanelParser::SaveData() {
